...
//check the balance of the upper account
web3_url.eth.getBalance(address, (err, bal) => { balance = bal})

//below command work in node terminal only

// balance
// web3_url.utils.fromWei(balance, 'ether')

// web3_url.eth.accounts.create()